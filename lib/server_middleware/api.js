 ...
 * @returns {Function}
 */
function actionHandler(ControllerClass, methodName, options, controllerFile) {
    ...
    Object.keys(routes).forEach(function (methodName) {
        ...
        if (ControllerClass.prototype[methodName]) {
            router[verb.toLowerCase()](
                ...
                actionHandler(ControllerClass, methodName, options, controllerFile) // Handle controller action method.
            );
        }
    });
